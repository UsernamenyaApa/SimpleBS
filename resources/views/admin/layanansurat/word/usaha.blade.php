<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN USAHA</b></u></p>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 5px;">Orang tersebut diatas berdasarkan keterangan Rt/Rw setempat dan menurut data yang ada pada desa kami, adalah benar-benar warga kami yang mempunyai usaha di bidang :
    </p>

    <p style="text-align: center; margin: 15px 0;">
        <b style="font-size: 14pt; text-transform: uppercase;"><i>&ldquo;{{ $pengajuan->data['bidang_usaha'] ?? '......................' }}&rdquo;</i></b>
    </p>
