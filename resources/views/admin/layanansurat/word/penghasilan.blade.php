<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 5px;">
        Orang tersebut diatas berdasarkan keterangan Rt/Rw setempat dan menurut data yang ada pada desa kami, adalah benar-benar warga kami yang pekerjannya sebagai: {{ strtoupper($pengajuan->data['pekerjaan'] ?? '......................') }}
    </p>
