<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN PENGHASILAN</b></u></p>
        <p style="margin:0; font-size: 11pt;">Nomor: {{ $pengajuan->nomor_surat ?? '400.10.2.2/....../Ds.Banjarsari' }}</p>
    </div>

    <br />

    {{-- ISI SURAT --}}
    <p style="text-align: justify; margin-bottom: 10px;">Yang bertanda tangan di bawah ini Kepala Desa Banjarsari Kecamatan Bayongbong Kabupaten Garut, dengan ini menerangkan dengan sebenarnya bahwa :</p>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 5px;">Orang tersebut diatas berdasarkan keterangan Rt/Rw setempat dan menurut data yang ada pada desa kami, adalah benar-benar warga kami yang pekerjannya sebagai: {{ strtoupper($pengajuan->data['pekerjaan'] ?? '......................') }}
    </p>

    <p style="text-align: justify; text-indent: 40px; margin-top: 5px; margin-bottom: 5px;">
        penghasilan rata rata perbulan sebesar Rp. {{ $pengajuan->data['penghasilan'] ?? '......................' }},-
    </p>

    <p style="text-align: justify; text-indent: 40px; margin-top: 5px; margin-bottom: 10px;">
        Dengan jumlah tanggungan sebanyak {{ $pengajuan->data['tanggungan'] ?? '...' }} orang.
    </p>
