<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <hr style="height: 3px; color: #000000; margin-bottom: 20px;" />

    {{-- JUDUL SURAT --}}
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN TIDAK MAMPU</b></u></p>
        <p style="margin:0; font-size: 11pt;">Nomor: {{ $pengajuan->nomor_surat ?? '145.1/.../VII/Ds.-2017' }}</p>
    </div>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 10px;">Yang tersebut di atas berdasarkan keterangan dari ketua rt/rw setempat dan menurut data yang ada pada kami, adalah benar-benar warga kami, yang tergolong dalam keluarga tidak mampu (Pra-Ks).
    </p>
