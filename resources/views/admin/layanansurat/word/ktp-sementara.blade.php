<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN KTP SEMENTARA</b></u></p>
        <p style="margin:0; font-size: 11pt;">Nomor: {{ $pengajuan->nomor_surat ?? '474.4/....../IV/Ds.-'.date('Y') }}</p>
    </div>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 10px;">Yang tersebut diatas berdasarkan keterangan Rt/Rw setempat dan menurut data yang ada pada kami, adalah benar-benar warga kami, dan memohon surat keterangan KTP sementara karena e-KTP dalam proses pembuatan.
    </p>
