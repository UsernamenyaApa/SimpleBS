<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN DOMISILI USAHA</b></u></p>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 5px;">Pada saat ini benar mempunyai usaha sebagaimana berikut ini :</p>

    {{-- TABEL DATA USAHA --}}
    <table border="0" style="border-color: #FFFFFF;">
        <tr>
            <td width="200" style="padding: 1px 0 1px 20px;">Jenis Usaha</td>
            <td width="15" style="text-align: center; padding: 1px 0;">:</td>
            <td width="300" style="padding: 1px 0;">{{ strtoupper($pengajuan->data['jenis_usaha'] ?? '-') }}</td>
        </tr>
        <tr>
            <td width="200" style="padding: 1px 0 1px 20px;">Pemilik</td>
            <td width="15" style="text-align: center; padding: 1px 0;">:</td>
            <td width="300" style="padding: 1px 0;">{{ strtoupper($pengajuan->data['pemilik'] ?? '-') }}</td>
        </tr>
        <tr>
            <td width="200" style="padding: 1px 0 1px 20px;">Alamat Usaha</td>
            <td width="15" style="text-align: center; padding: 1px 0;">:</td>
            <td width="300" style="padding: 1px 0;">{{ strtoupper($pengajuan->data['alamat_usaha'] ?? '-') }}</td>
        </tr>
    </table>
