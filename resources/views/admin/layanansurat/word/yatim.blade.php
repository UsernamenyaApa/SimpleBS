<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN YATIM</b></u></p>
        <p style="margin:0; font-size: 11pt; text-transform: uppercase;">NOMOR : {{ $pengajuan->nomor_surat ?? '474.2/....../ VII /DS-'.date('Y') }}</p>
    </div>
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 15px;">Yang tersebut diatas berdasarkan keterangan dari RT/RW setempat dan menurut data yang ada pada kantor kami, adalah benar-benar warga kami.
    </p>
    ...
    <table border="0" style="width: 100%; border-color: #FFFFFF;">
        <tr>
            <td width="250" style="text-align: center;">
                ...
                <br /><br /><br /><br />
                <p style="margin:0;"><u><b>{{ isset($pengajuan->user->name) ? strtoupper($pengajuan->user->name) : '.........................' }}</b></u></p>
            </td>
            <td width="250" style="text-align: center;">
