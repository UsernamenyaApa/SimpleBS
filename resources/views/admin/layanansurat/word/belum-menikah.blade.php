<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.15;">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <p style="margin:0;"><u><b>SURAT KETERANGAN BELUM MENIKAH</b></u></p>
    ...
    {{-- TABEL BIODATA (UKURAN LEBAR DALAM PIXEL/TWIP COMPATIBLE) --}}
    ...
    <p style="text-align: justify; margin-top: 10px; margin-bottom: 10px;">Yang tersebut diatas berdasarkan keterangan dari petugas pencatat pernikahan dan menurut data yang ada pada kami, adalah benar-benar warga kami yang <b><i>BELUM MENIKAH</i></b>.
    </p>
