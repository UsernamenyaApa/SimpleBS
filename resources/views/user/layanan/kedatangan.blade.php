        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-[#1d4ed8] rounded-2xl p-8 text-white shadow-lg shadow-blue-100 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <h1 class="text-3xl font-bold mb-4">Pelayanan Kedatangan</h1>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900">Persyaratan Kedatangan:</h2>
                </div>

                <ul class="space-y-4 ml-1">
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Surat Keterangan Pindah WNI (SKPWNI);</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">KTP-el (Khusus 17 tahun keatas);</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Akta Lahir Pendatang (jika dibawah umur);</span>
                    </li>
                    ...
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <div class="flex-1">
                            <span class="text-gray-700 text-sm block mb-2">Jika status numpang KK:</span>
                            <ul class="pl-2 border-l-2 border-gray-100 ml-1 space-y-2">
                                <li class="flex items-center gap-2 text-sm text-gray-600">
                                    <span class="w-1.5 h-1.5 rounded-full bg-green-400"></span>
                                    KK tujuan yang ditumpangi;
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <div class="flex-1">
                            <span class="text-gray-700 text-sm block mb-2">Jika status numpang KK berusia dibawah 17 tahun:</span>
                            <ul class="pl-2 border-l-2 border-gray-100 ml-1 space-y-2">
                                <li class="flex items-center gap-2 text-sm text-gray-600">
                                    <span class="w-1.5 h-1.5 rounded-full bg-green-400"></span>
                                    KK tujuan yang ditumpangi;
                                ...
                                <li class="flex items-center gap-2 text-sm text-gray-600">
                                    <span class="w-1.5 h-1.5 rounded-full bg-green-400"></span>
                                    KTP-el Kepala Keluarga pada KK yang akan ditumpangi;
                                </li>
                                <li class="flex items-start gap-2 text-sm text-gray-600">
                                    <span class="w-1.5 h-1.5 rounded-full bg-green-400 mt-1.5 flex-shrink-0"></span>
                                    <span>Surat Pernyataan bersedia oleh kepala keluarga yang ditumpangi ditandatangani di atas materai Rp. 10.000,-;</span>
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <ul class="space-y-4 ml-1">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-gray-700 text-sm">Pemohon adalah yang bersangkutan atau dalam satu KK;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Petugas pelayanan melakukan verifikasi dan validasi terhadap dan persyaratan;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                    ...
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Petugas menacakonfirmasi status kedatangan yang telah selesai di proses kepada pemohon.</span>
                    </li>
                </ul>
            </div>
