            ...
            <div class="bg-[#1d4ed8] rounded-2xl p-8 text-white shadow-lg shadow-blue-100 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold mb-4">Pelayanan Perbaikan Data Akta Kelahiran</h1>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <ul class="space-y-4 ml-1">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-gray-700 text-sm">Formulir Perbaikan Akta Kelahiran (dapat di download di menu formulir persyaratan);</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                    ...
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Akta Kelahiran lama;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Dokumen dasar perbaikan (Ijazah/Buku Nikah Orangtua);</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Materai Rp. 10.000,-;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 flex-shrink-0"></i>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <ul class="space-y-4 ml-1">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-gray-700 text-sm">Pemohon adalah yang berkepentingan/tidak diwakilkan;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Pemohon mengisi dan menandatangani formulir di atas materai Rp. 10.000,- dan memberikan persyaratan lengkap;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Petugas pelayanan melakukan verifikasi dan validasi terhadap formulir dan persyaratan;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Petugas pelayanan melakukan perbaikan data dalam Sistem Informasi Administrasi Kependudukan;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                    ...
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Petugas menerbitkan Akta Kelahiran;</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="far fa-check-circle text-gray-400 mt-1 flex-shrink-0"></i>
                        <span class="text-gray-700 text-sm">Kutipan Akta Kelahiran disampaikan kepada pemohon.</span>
                    </li>
                </ul>
            </div>
