...
<head>
    <meta charset="utf-8"/>
    <title>{{ $title ?? 'Surat Keterangan Penghasilan' }}</title>
    <style>
        body {
...
<div class="page-wrapper">
    ...
    {{-- ISI SURAT --}}
    <div class="content">
        <p>Yang bertanda tangan di bawah ini Kepala Desa Banjarsari Kecamatan Bayongbong Kabupaten Garut, dengan ini menerangkan dengan sebenarnya bahwa :</p>
        ...
        <table class="table-data">
            ...
            <tr>
                ...
                <td class="colon">:</td>
                {{-- Menggunakan isian pekerjaan dari form, atau default jika kosong --}}
        ...
        <p class="indent-text" style="margin-top: 5px; margin-bottom: 5px;">
            penghasilan rata rata perbulan sebesar Rp. {{ $pengajuan->data['penghasilan'] ?? '......................' }},-
        </p>

        <p class="indent-text" style="margin-top: 5px;">
