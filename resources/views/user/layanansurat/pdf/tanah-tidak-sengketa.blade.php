...
<head>
    <meta charset="utf-8"/>
    <title>{{ $title ?? 'Surat Keterangan Tanah Tidak Sengketa' }}</title>
    <style>
        body {
...
<div class="page-wrapper">
    ...
    <div class="title-container">
        <u>SURAT KETERANGAN TIDAK DALAM SENGKETA DAN BELUM DISERTIFIKATKAN</u>
        <div class="nomor-surat">Nomor: {{ $pengajuan->nomor_surat ?? '594/....../X/Ds.-'.date('Y') }}</div>
    </div>

    {{-- ISI SURAT --}}
    <div class="content">
        <p>Yang bertanda tangan di bawah ini Kepala Desa Banjarsari Kecamatan Bayongbong Kabupaten Garut, dengan ini menerangkan bahwa Tanah milik dari :</p>
        ...
        <table class="table-data">
            ...
            <tr>
                ...
                <td class="colon">:</td>
                <td>{{ $pengajuan->data['umur'] ?? '-' }} Tahun</td>
            </tr>
            <tr>
        ...
        <p>
            Tanah milik saudara {{ isset($pengajuan->data['nama']) ? strtoupper($pengajuan->data['nama']) : '......................' }} sampai saat ini tidak dalam sengketa dan belum pernah disertifikatkan.
        </p>
