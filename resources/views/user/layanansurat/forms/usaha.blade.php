    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-start gap-4 mb-8 border-b border-gray-100 pb-6">
                <div class="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center flex-shrink-0 border border-purple-100">
                    <i class="fas fa-store text-purple-600 text-xl"></i>
                </div>
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Formulir Keterangan Usaha</h1>
                    <p class="text-sm text-gray-500 mt-1">Surat ini menerangkan bahwa pemohon memiliki usaha yang berjalan di wilayah desa.</p>
                </div>
            </div>

            <form action="{{ route('layanan.store', 'usaha') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- SECTION 1: IDENTITAS PEMOHON -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-purple-500 pl-3">Data Diri Pemohon</h3>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="nik" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3 transition-shadow" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="ttl" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3" 
                                   value="{{ old('ttl') }}" placeholder="GARUT, 25-04-1990">
                            <div class="mt-2 flex items-center gap-1 text-xs text-gray-500">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        ...
                        <div>
                            ...
                            <select name="jenis_kelamin" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="pekerjaan" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3" 
                                   value="{{ old('pekerjaan') }}" placeholder="Wiraswasta / Pedagang">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Status Perkawinan <span class="text-red-500">*</span></label>
                            <select name="status" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3">
                        ...
                        <div>
                            ...
                            <select name="agama" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3">
                ...
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-purple-500 pl-3">Informasi Usaha</h3>
                    
                    <div class="bg-purple-50 border border-purple-100 rounded-xl p-5">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Bidang Usaha yang Dijalankan <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="bidang_usaha" required 
                               class="w-full bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-purple-500 focus:border-purple-500 block p-3" 
                               value="{{ old('bidang_usaha') }}" 
                               placeholder="Contoh: WARUNG SEMBAKO, BENGKEL MOTOR, JUAL BELI HASIL BUMI">
                        <p class="text-xs text-gray-500 mt-2">Sebutkan jenis usaha atau dagangan secara spesifik.</p>
                    </div>
                </div>

                <!-- SECTION 3: LAMPIRAN -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-purple-500 pl-3">Berkas Pendukung</h3>
                    
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-4 flex items-start gap-3">
                        <i class="fas fa-info-circle text-blue-500 mt-0.5"></i>
                        <p class="text-sm text-blue-700">Silakan upload Scan/Foto <strong>KTP</strong> dan <strong>Surat Pengantar RT/RW</strong> sebagai syarat pengajuan.</p>
                    </div>
                        ...
                        <label for="file-input"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500">
                                    <span class="font-semibold text-purple-600">Klik untuk upload</span> atau drag and drop
                                </p>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-purple-600 text-white rounded-xl font-medium text-center hover:bg-purple-700 shadow-lg shadow-purple-200 transition-all flex items-center justify-center gap-2">
