<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-start gap-4 mb-8 border-b border-gray-100 pb-6">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Formulir Keterangan Penghasilan</h1>
                    <p class="text-sm text-gray-500 mt-1">Surat ini menerangkan status pekerjaan dan rata-rata penghasilan per bulan.</p>
                </div>
            </div>

            <form action="{{ route('layanan.store', 'penghasilan') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- SECTION 1: IDENTITAS PEMOHON -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-emerald-500 pl-3">Data Diri Pemohon</h3>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="nik" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3 transition-shadow" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="ttl" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3" 
                        ...
                        <div>
                            ...
                            <select name="jenis_kelamin" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3">
                    ...
                    <!-- Grid Status, Agama, Kewarganegaraan -->
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Status Perkawinan <span class="text-red-500">*</span></label>
                            <select name="status" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3">
                        ...
                        <div>
                            ...
                            <select name="agama" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3">
                ...
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-emerald-500 pl-3">Informasi Pekerjaan & Penghasilan</h3>
                    
                    <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-5 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan" required 
                                   class="w-full bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3" 
                                   value="{{ old('pekerjaan') }}" 
                                   placeholder="Contoh: Buruh Harian Lepas, Pedagang, Petani">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Penghasilan Rata-rata (Per Bulan) <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    ...
                                    <input type="text" name="penghasilan" id="penghasilan" required 
                                           class="w-full bg-white pl-10 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3" 
                                           value="{{ old('penghasilan') }}" 
                                           placeholder="2.000.000" onkeyup="formatRupiah(this)">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="tanggungan" required min="0" 
                                           class="w-full bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3 pr-16" 
                ...
                <!-- SECTION 3: LAMPIRAN -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-emerald-500 pl-3">Berkas Pendukung</h3>
                    
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-4 flex items-start gap-3">
                        <i class="fas fa-info-circle text-blue-500 mt-0.5"></i>
                        <p class="text-sm text-blue-700">Silakan upload Scan/Foto <strong>KTP</strong> dan <strong>Kartu Keluarga (KK)</strong> sebagai syarat verifikasi data.</p>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-emerald-600 text-white rounded-xl font-medium text-center hover:bg-emerald-700 shadow-lg shadow-emerald-200 transition-all flex items-center justify-center gap-2">
    ...
    <!-- SCRIPT PREVIEW FILE & FORMAT RUPIAH -->
    <script>
