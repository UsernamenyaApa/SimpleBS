    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-start gap-4 mb-8 border-b border-gray-100 pb-6">
                <div class="w-12 h-12 bg-fuchsia-50 rounded-xl flex items-center justify-center flex-shrink-0 border border-fuchsia-100">
                    <i class="fas fa-heart-broken text-fuchsia-600 text-xl"></i>
                </div>
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Formulir Keterangan Belum Menikah</h1>
                    <p class="text-sm text-gray-500 mt-1">Surat ini menerangkan bahwa pemohon berstatus belum pernah menikah (Jejaka/Perawan) atau status saat ini sendiri.</p>
                </div>
            </div>

            <form action="{{ route('layanan.store', 'belum-menikah') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- SECTION 1: DATA DIRI -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-fuchsia-500 pl-3">Identitas Pemohon</h3>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="nik" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3 transition-shadow" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="ttl" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3" 
                        ...
                        <div>
                            ...
                            <select name="jenis_kelamin" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="pekerjaan" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3" 
                                   value="{{ old('pekerjaan') }}" placeholder="Wiraswasta / Belum Bekerja">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Status Perkawinan <span class="text-red-500">*</span></label>
                            <select name="status" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3">
                        ...
                        <div>
                            ...
                            <select name="agama" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="keperluan" rows="2" required 
                                  class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-3"
                                  placeholder="Contoh: PERSYARATAN NIKAH / MELAMAR PEKERJAAN">{{ old('keperluan') }}</textarea>
                    </div>
                </div>

                <!-- SECTION 2: LAMPIRAN -->
                <div class="mb-8">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-fuchsia-500 pl-3">Berkas Pendukung</h3>
                    
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-4 flex items-start gap-3">
                        <i class="fas fa-info-circle text-blue-500 mt-0.5"></i>
                        <p class="text-sm text-blue-700">Silakan upload Scan/Foto <strong>KTP</strong> dan <strong>Kartu Keluarga (KK)</strong>. Untuk status Janda/Duda, lampirkan <strong>Akta Cerai/Surat Kematian Pasangan</strong>.</p>
                    </div>
                        ...
                        <label for="file-input"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500">
                                    <span class="font-semibold text-fuchsia-600">Klik untuk upload</span> atau drag and drop
                                </p>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-fuchsia-600 text-white rounded-xl font-medium text-center hover:bg-fuchsia-700 shadow-lg shadow-fuchsia-200 transition-all flex items-center justify-center gap-2">
