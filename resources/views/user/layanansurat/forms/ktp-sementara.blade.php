    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-start gap-4 mb-8 border-b border-gray-100 pb-6">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Formulir Keterangan KTP Sementara</h1>
                    <p class="text-sm text-gray-500 mt-1">Isi data diri anda untuk penerbitan Surat Keterangan KTP Sementara.</p>
                </div>
            </div>

            <form action="{{ route('layanan.store', 'ktp-sementara') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- SECTION 1: IDENTITAS PRIBADI -->
                <div class="mb-6">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-cyan-500 pl-3">Data Diri Pemohon</h3>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" required 
                                   class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-cyan-500 focus:border-cyan-500 block p-3 transition-shadow" 
                                   value="{{ old('nama', Auth::user()->name ?? '') }}" placeholder="Sesuai Akta Kelahiran/KK">
                            <div class="mt-2 flex items-center gap-1 text-xs text-gray-500">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                <div class="mt-8 mb-6">
                    <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-l-4 border-cyan-500 pl-3">Data Pelengkap</h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Agama -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Agama <span class="text-red-500">*</span></label>
                            <select name="agama" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-cyan-500 focus:border-cyan-500 block p-3">
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-cyan-500 focus:border-cyan-500 block p-3">
